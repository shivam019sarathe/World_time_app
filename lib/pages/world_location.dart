...
class ChooseWorldLocation extends StatefulWidget {
  @override
  _ChooseWorldLocationState createState() => _ChooseWorldLocationState();
}

class _ChooseWorldLocationState extends State<ChooseWorldLocation> {
  ...
  void venue() {
    var i,l;
    for (i = 0; i < worldurl.length; i++) {
      l = worldurl[i].split('/');
      if(l.length > 2){
        worldlocation.add(l[1]+ '/' + l[2] ) ;
      }
      else{
        worldlocation.add(l[1]);
      }
    }
    //print(worldlocation);
  }
  ...
  destination() {
     var j;
    for (j=0 ; j<worldurl.length ; j++){

        urla  = worldurl[j];
        lctn  = worldlocation[j];

        tr.add( WorldTime(location: worldlocation[j] , Flag: '' , url: worldurl[j]));
    }
    //print(tr);
      ...
      backgroundColor: Colors.black,
        appBar: AppBar(
          backgroundColor: Colors.grey[800],
           title: !isSearching? Text('All locations '): TextField(
          ...
          return Padding(
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                title: Text(tr[index].location),
                leading: CircleAvatar(


                  backgroundImage: AssetImage('assets/${tr[index].Flag}' ) ,
